  ...
  return (
    ...
    <div className="min-h-screen bg-black text-white px-8 py-12">
      ...
      <p className="text-lg text-zinc-300 mb-12">
        Based on your style quiz + past favorites, here’s what’s trending in your vibe this week:
      </p>
  ...
  <div className="relative">
    ...
    <div className="flex space-x-6 overflow-x-auto no-scrollbar pb-2">
      ...
      <section className="mb-16">
        ...
        <p className="mb-2">Budget: $120 | Spent: $88.40</p>
        <div className="bg-zinc-800 h-4 w-full rounded-full">
          <div className="bg-pink-500 h-4 rounded-full w-[73%] transition-all"></div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc pl-5 text-zinc-300 space-y-1">
          ...
          <li>Favorite category: Bags & Accessories</li>
